...
void main() {
  group('option', () {
    ...
    test('cast', () {
      expect(Some<num>(42).cast<int>() is Some<int>, isTrue);
      expect(None<num>().cast<int>() is None<int>, isTrue);
    });
    ...
    test('match', () {
      ...
      expect(
          () => Some(42).match(some: null, none: null), throwsAssertionError);
      expect(() => Some(42).match(some: (value) => value + 1, none: null),
          throwsAssertionError);
      expect(() => Some(42).match(some: null, none: () => 13),
          throwsAssertionError);
